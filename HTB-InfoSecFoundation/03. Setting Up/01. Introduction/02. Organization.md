...
```shell-session
mimnets@htb[/htb]$ script 03-21-2021-0200pm-exploitation.log

mimnets@htb[/htb]$ ...SNIP...
mimnets@htb[/htb]$ exit
```
...
```shell-session
mimnets@htb[/htb]$ ./custom-tool.py 10.129.28.119 > logs.custom-tool
```

  Organization

```shell-session
mimnets@htb[/htb]$ ./custom-tool.py 10.129.28.119 | tee -a logs.custom-tool
```
...
 [Previous](https://academy.hackthebox.com/module/87/section/879)

 Mark Complete & Next

[Next](https://academy.hackthebox.com/module/87/section/881)